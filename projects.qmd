        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem; margin: 1rem 0;">
          ...
          <div>
            ...
            <p style="font-size: 13px; line-height: 1.4; margin-top:8px;">
              ...
              <a href="[https://roymwavita.shinyapps.io/survey_tracker/](https://roymwavita.shinyapps.io/survey_tracker/)" target="_blank">Link to dashboard</a> 
            </em>
            </p>
          </div>
        </div>
...
add_validation(
  ...
  check
        ...
        <p style="margin-top: 1.5rem;">
          <a href="[https://github.com/roy-mwavita0/validationcheck](https://github.com/roy-mwavita0/validationcheck)" target="_blank">
