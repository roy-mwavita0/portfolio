...
<div class="content-showcase">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="notes.html"><i class="fas fa-book-open"></i> Blog</a>
  </nav>
  ...
  <div class="project-grid">
    ...
    <!-- Card 1: MyJobMag Web Scraping -->
    <div class="project-card">
      <div>
        <h2>🕷️ Automated Job Scraping & Dashboard</h2>
        <p>
          An automated web scraping pipeline that extracts job postings
          from MyJobMag, processes them in R, and displays real-time
          insights through an interactive Shiny dashboard with filtering,
          trend analysis, and visualization tools.
        </p>
      </div>
      <button onclick="openModal('myjobmagModal')">
        Read more →
      </button>
    </div>
    ...
    <!-- Card 4: validationcheck Package -->
    <div class="project-card">
      <div>
  ...
  <!-- Modal: MyJobMag Web Scraping Dashboard -->
  <div id="myjobmagModal" class="modal">
    <div class="modal-content">
      <span class="close" onclick="closeModal('myjobmagModal')">&times;</span>

      <h2>🕷️ Automated Job Scraping & Dashboard</h2>

      <p><strong>Project Type:</strong> Web Scraping & Interactive Dashboard</p>

      <p><strong>Status:</strong> 🟢 Live Demonstration Project</p>

      <p><strong>Tools & Technologies:</strong>
        R, rvest, tidyverse, lubridate, Shiny, shinydashboard,
        highcharter, DT, plotly, wordcloud, tm, waiter, shinyapps.io, GitHub
      </p>
      ...
      <p>
        Job seekers often spend hours manually refreshing job websites,
        scrolling through cluttered pages, and trying to identify new
        opportunities. Websites like MyJobMag don't always display
        vacancies in clear chronological order, and the interface is
        filled with advertisements that make navigation difficult.
        This results in wasted time, missed opportunities, and a
        frustrating job search experience.
      </p>
      ...
      <p>
        I built an automated web scraping pipeline that extracts job
        postings from MyJobMag, processes them in R, and displays
        the results through an interactive Shiny dashboard.
      </p>

      <p>
        The system scrapes job titles, companies, dates, and links
        from multiple pages, cleans and structures the data,
        filters jobs by date range and company, visualizes hiring
        trends, and provides a clean, ad-free interface for job searching.
      </p>
      ...
      <ul>
        <li>🌐 MyJobMag Website – Source of job postings</li>
        <li>🕷️ rvest – Web scraping engine</li>
        <li>🧹 R + tidyverse – Data cleaning and transformation</li>
        <li>📅 lubridate – Date parsing and filtering</li>
        <li>📊 Shiny Dashboard – Interactive visualization</li>
        <li>☁️ shinyapps.io – Cloud deployment</li>
      </ul>

      <hr>

      <h3>🕷️ Data Collection Process</h3>

      <p>The scraper performs the following steps:</p>

      <ul>
        <li><strong>Extracts</strong> job listings from MyJobMag pages</li>
        <li><strong>Parses</strong> job titles to extract company names from " at " patterns</li>
        <li><strong>Filters</strong> jobs based on recency (configurable date range)</li>
        <li><strong>Removes</strong> duplicate entries using unique URLs</li>
        <li><strong>Stores</strong> the data in a structured format for analysis</li>
      </ul>

      <p><strong>Data Collected:</strong></p>
      <ul>
        <li>Job Title (cleaned)</li>
        <li>Company Name (extracted from title)</li>
        <li>Date Posted (parsed and validated)</li>
        <li>Job URL (complete link)</li>
        <li>Page Source (for pagination tracking)</li>
      </ul>
      ...
      <ul>
        <li>Total jobs scraped</li>
        <li>New jobs today</li>
        <li>Number of hiring companies</li>
      </ul>

      <p><strong>Visualizations:</strong></p>
      <ul>
        <li>📈 Jobs posted over time (trend analysis)</li>
        <li>🏆 Top hiring companies (bar chart)</li>
        <li>☁️ Word cloud of job titles (keyword patterns)</li>
        <li>📅 Jobs by day of week (best days to check)</li>
      </ul>

      <p><strong>Interactive Filters:</strong></p>
      <ul>
        <li>Date range selector</li>
        <li>Company name filter</li>
        <li>Real-time data refresh</li>
      </ul>

      <p><strong>Data Export:</strong></p>
      <ul>
        <li>Download filtered results as CSV</li>
      </ul>
      ...
      <p><strong>Scraping Logic:</strong></p>
      <pre style="background: #f5f5f5; padding: 10px; border-radius: 5px; overflow-x: auto; font-size: 13px;">
  myjobmag_jobs &lt;- function(base_url, max_pages = 7, days_back = 7) {
    ...
    # Returns cleaned, deduplicated job data as a tibble
      ...
      <p><strong>Title Parsing:</strong></p>
      <pre style="background: #f5f5f5; padding: 10px; border-radius: 5px; overflow-x: auto; font-size: 13px;">
  ...
  if (str_detect(title, " at ")) {
    ...
    company &lt;- str_trim(parts[2])
      ...
      <div style="display: flex; flex-wrap: wrap; gap: 10px; margin: 10px 0;">
        <img src="images/myjobmag_dashboard.png"
             alt="MyJobMag Dashboard Screenshot"
             style="width: 100%; max-width: 600px; border-radius: 8px; border: 1px solid #ddd;">
      </div>

      <p><strong>Key Views:</strong></p>
      <ul>
        <li><strong>Overview Dashboard</strong> – KPI cards and trend charts</li>
        <li><strong>Job Listings</strong> – Searchable, sortable data table</li>
        <li><strong>Word Cloud</strong> – Visual analysis of job title keywords</li>
      </ul>
      ...
      <ul>
        <li><strong>Eliminated manual scrolling</strong> – Jobs are automatically collected and displayed</li>
        <li><strong>Chronological sorting</strong> – Always see the latest jobs first</li>
        <li><strong>Time savings</strong> – Reduced job search time from hours to minutes</li>
        <li><strong>Better insights</strong> – Visualize hiring trends and identify top employers</li>
        <li><strong>Open-source solution</strong> – Built entirely with free R packages</li>
        <li><strong>Scalable framework</strong> – Can be adapted to other job websites</li>
      </ul>
      ...
      <ul>
        <li>Add email alerts for new jobs matching keywords</li>
        <li>Scrape individual job pages for more details (salary, location)</li>
        <li>Schedule daily automated scraping with cron</li>
        <li>Add job application tracking feature</li>
        <li>Integrate with job application database</li>
      </ul>
      ...
      <ul>
        <li><strong>Web scraping requires understanding HTML structure</strong> – Every website is different</li>
        <li><strong>Respect website terms</strong> – Add delays between requests to be a good web citizen</li>
        <li><strong>Handle errors gracefully</strong> – Websites change, so build robust error handling</li>
        <li><strong>Clean data matters</strong> – Job titles need parsing to extract meaningful information</li>
        <li><strong>Interactive dashboards make data useful</strong> – Visualizations help spot trends</li>
      </ul>
      ...
      <p>
        <a href="https://roymwavita.shinyapps.io/myjobmag_webscraping/"
           target="_blank">
           📊 View Live Dashboard
        </a>
      </p>
      ...
      <p>
        <a href="https://roy-mwavita0.github.io/portfolio/thread.html?id=web-scraping-myjobmag"
           target="_blank">
  ...
  <div id="bintiImaraModal" class="modal">
    <div class="modal-content">
      ...
      <img src="images/bii_worflow.png"
           alt="Binti Imara Workflow">
